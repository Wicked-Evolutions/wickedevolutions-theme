...
<h6 class="wp-block-heading we-nav-label has-muted-color has-text-color has-mono-font-family" style="font-size:0.75rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;margin-top:16px">Reference Library</h6>
<!-- /wp:heading -->
<?php
wp_nav_menu( [
