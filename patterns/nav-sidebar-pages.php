...
<!-- wp:heading {"level":6,"style":{"typography":{"fontSize":"0.75rem","fontWeight":"700","letterSpacing":"0.08em","textTransform":"uppercase"}},"textColor":"muted","fontFamily":"mono","className":"we-nav-label"} -->
<h6 class="wp-block-heading we-nav-label has-muted-color has-text-color has-mono-font-family" style="font-size:0.75rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase">Pages</h6>
<!-- /wp:heading -->
<?php
wp_nav_menu( [
